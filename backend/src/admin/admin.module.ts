...
export class AdminService {
  ...
  createService(b: Body0) {
    return this.prisma.service.create({
      data: pick(b, ['nameUz', 'nameRu', 'images', 'isActive', 'comingSoon', 'hasPowerField', 'sortOrder']) as Prisma.ServiceCreateInput,
    });
  }
  async updateService(id: string, b: Body0) {
    ...
    return this.prisma.service.update({
      where: { id },
      data: pick(b, ['nameUz', 'nameRu', 'images', 'isActive', 'comingSoon', 'hasPowerField', 'sortOrder']),
    });
  }
